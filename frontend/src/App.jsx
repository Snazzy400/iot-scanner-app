...
const API = "https://threshold-rest-firmware-thinking.trycloudflare.com";
...
function LoginPage({ onLogin }) {
  ...
  return (
    <div style={{ minHeight: "100vh", width: "100vw", background: "#141c28", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "monospace", position: "relative", overflow: "hidden" }}>
      <style>{`
